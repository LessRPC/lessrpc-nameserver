...
public class NameServerTest implements NameServerServices {
	...
	//
	// NSClient client = new NSClient(nsSPInfo, new ArrayList<>());
	// boolean flag = client.register(new ServiceSupportInfo(service,
	// sampleProvider,
	// new SerializationFormat[] { SerializationFormat.defaultFotmat() }));
	// Assert.assertEquals(true, flag);
	//
	...
	//
	// Assert.assertEquals(1, provider.getSerializers().length);
	// Assert.assertEquals(SerializationFormat.defaultFotmat().getName(),
	// provider.getSerializers()[0].getName());
	// Assert.assertEquals(SerializationFormat.defaultFotmat().getVersion(),
	// provider.getSerializers()[0].getVersion());
	//
	...
	//
	// ServiceInfo<Integer> service = new ServiceInfo<Integer>("test", 1);
	// ServiceProviderInfo provider1 = new ServiceProviderInfo("tes1", ports[0],
	// EnvironmentInfo.currentEnvInfo());
	// ServiceProviderInfo provider2 = new ServiceProviderInfo("test2",
	// ports[1], EnvironmentInfo.currentEnvInfo());
	// ServiceProviderInfo provider3 = new ServiceProviderInfo("test3",
	// ports[2], EnvironmentInfo.currentEnvInfo());
	//
	// ServiceInfo<Integer> service2 = new ServiceInfo<Integer>("tes2", 2);
	// ServiceProviderInfo provider4 = new ServiceProviderInfo("tes1", ports[3],
	// EnvironmentInfo.currentEnvInfo());
	//
	// NSClient client = new NSClient(nsSPInfo, new ArrayList<>());
	// boolean flag = client.register(new ServiceSupportInfo(service, provider1,
	// new SerializationFormat[] { SerializationFormat.defaultFotmat() }));
	// boolean flag2 = client.register(new ServiceSupportInfo(service,
	// provider2,
	// new SerializationFormat[] { SerializationFormat.defaultFotmat() }));
	// boolean flag3 = client.register(new ServiceSupportInfo(service,
	// provider3,
	// new SerializationFormat[] { SerializationFormat.defaultFotmat() }));
	// boolean flag4 = client.register(new ServiceSupportInfo(service2,
	// provider4,
	// new SerializationFormat[] { SerializationFormat.defaultFotmat() }));
	//
	...
	//
	// Assert.assertEquals(SerializationFormat.defaultFotmat(),
	// providers[0].getSerializers()[0]);
	// Assert.assertEquals(SerializationFormat.defaultFotmat(),
	// providers[1].getSerializers()[0]);
	// Assert.assertEquals(SerializationFormat.defaultFotmat(),
	// providers[2].getSerializers()[0]);
	//
