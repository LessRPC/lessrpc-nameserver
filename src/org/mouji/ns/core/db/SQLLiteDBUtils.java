...
public class SQLLiteDBUtils extends SQLBasedUtils {
	...
	public boolean createServiceTable(Connection conn) {
		String sql = "CREATE TABLE IF NOT EXISTS " + DB_SQL_TABLE_NAME_SERVICE + "("
				...
				+ " TEXT); CREATE INDEX SERIVCE_NAME_IDX ON SERVICE(" + DB_SQL_TABLE_COLUMN_NAME_NAME + ");";
		try {
	...
	public boolean createServiceProviderTable(Connection conn) {
		...
		String sql = "CREATE TABLE IF NOT EXISTS " + DB_SQL_TABLE_NAME_SERVICE + " ("
				+ DB_SQL_TABLE_COLUMN_NAME_SERVICE_PROVIDER_ID + " INT PRIMARY KEY ASC, "
				+ DB_SQL_TABLE_COLUMN_NAME_SERVICE_ID + " INT, " + DB_SQL_TABLE_COLUMN_NAME_URL + " TEXT, "
				+ DB_SQL_TABLE_COLUMN_NAME_PORT + " INT); CREATE INDEX SERIVCE_PROVIDER_SERVICE_ID_IDX ON "
				+ DB_SQL_TABLE_NAME_SERVICE_PROVIDER + "(" + DB_SQL_TABLE_COLUMN_NAME_SERVICE_ID
				+ ");CREATE INDEX SERIVCE_PROVIDER_URL_PORT_IDX ON " + DB_SQL_TABLE_NAME_SERVICE_PROVIDER + "("
	...
	public boolean createServiceSupportTable(Connection conn) {
		String sql1 = "CREATE TABLE IF NOT EXISTS " + DB_SQL_TABLE_NAME_SERVICE_PROVIDER_SUPPORT + "("
				+ DB_SQL_TABLE_COLUMN_NAME_SUPPORT_ID + " INT PRIMARY KEY ASC, "
				...
				+ " TEXT); CREATE INDEX SUPPORT_SP_ID_IDX ON SERVICE_PROVIDER_SUPPORT("
